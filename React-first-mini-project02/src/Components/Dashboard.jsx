...
const Dashboard = () => {
  return (
    <div className="min-h-full p-5 mt-2.5">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
            ...
            <div className="rounded-3xl bg-[#c0e2d9] p-5 h-full relative overflow-hidden">
              ...
              <button className="mt-14 rounded-full bg-[#9db9ff] px-6 py-3 text-black text-sm font-medium shadow">
                Learn More
              </button>

              {/* Decorative circles */}
              <div className="absolute top-3 left-64 w-20 h-20 border-[1.5px] border-black/75 rounded-full"></div>
              <div className="absolute right-4 top-12 w-20 h-20 border-[1.5px] border-blue-300 rounded-full"></div>
